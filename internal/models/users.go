...
type Users struct {
	...
	Sex         string     `json:"sex,omitempty" column:"name:sex;type:text;nullable:false"`
	...
	UserId                                 *Users                  `json:"users,omitempty" onUpdate:"no action" onDelete:"no action" join:"joinType:hasOne;primaryKey:id;foreignKey:id"`
}
