...
type Appointments struct {
	...
	// Relations
	AppointmentReschedule                    *Appointments     `json:"appointments,omitempty" onUpdate:"no action" onDelete:"no action" join:"joinType:hasOne;primaryKey:id;foreignKey:reschedule_from"`
